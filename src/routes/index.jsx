...
export default function Component() {
	...
	return (
		<div id="index" className="app">
			<Link to={`/imgD`} data-href="imgD" className="index-link">
				<IndexItem name="ImgD" />
			</Link>
			<Link to={`/ytdl`} data-href="ytdl" className="index-link">
				<IndexItem name="YTDL" />
			</Link>
			<Link to={`/notebook`} data-href="notebook" className="index-link">
				<IndexItem name="NoteBook" />
			</Link>
		</div>
	);
}
