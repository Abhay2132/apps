...
export function Input({
	...
	return (
		<div style={style} className="iconed-input-box" mode={mode}>
			<img
				src={icon}
				height="30px"
				width="30px"
...
export function Option({
	...
	return (
		<button
			...
			onClick={onClick}
			className="option"
			style={{ margin: margin, color: color, background: bg }}
		>
			{children || text}
		</button>
	);
...
export function Switch({ state, value, style, onClick }) {
	return (
		<button state={state} onClick={onClick} className="switch" style={style}>
			{value}
		</button>
	);
}
