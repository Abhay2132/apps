...
export function PopupPanel({
	...
	return (
		<div
			id={id}
			className="popup-panel middle"
			panel-state={data.animate}
			style={{ display: data.display }}
		>
			<div className="popup-panel-bg" onClick={triggerClose}></div>
			<div className="popup-panel-body">
				<div className="popup-panel-topbar">
					<div className="popup-panel-title">{title}</div>
					<div className="popup-panel-close-btn" onClick={triggerClose}>
						<hr />
						<hr />
					</div>
				</div>
				<div className="popup-panel-body-main">{children}</div>

				<div className="popup-panel-footer">
					<div className="popup-panel-footer-text">{footer}</div>
					<button className="popup-panel-cancel" onClick={triggerClose}>
						{no}
					</button>
					<button className="popup-panel-ok" onClick={onDone}>
						{yes}
					</button>
				</div>
			</div>
